      ...
      <div class="absolute z-10 top-2 left-2 sm:static flex-shrink flex-grow-0">
        <div class="cursor-pointer">
          <RouterLink to="/" class="navbar-brand flex items-center">
            ...
            <span class="hidden ml-2 sm:block text-2xl font-semibold">Diginoodikogu</span>
          </RouterLink>
        </div>
      </div>
            ...
            <ul class="flex flex-wrap items-center justify-end w-full m-0">
                ...
                <template v-if="hasRole('Kasutaja')">
                    <li class="relative flex flex-wrap just-fu-start m-0">
                        <RouterLink to="/laulud" class="p-4 flex items-center justify-start mw-full hover:text-sky-500 dark:hover:text-sky-400" ActiveClass="text-blue-700 dark:text-blue-300">Laulud</RouterLink>
                    </li>
                </template>
                ...
                <template v-else>
                    <li class="relative flex flex-wrap just-fu-start m-0">
                        <RouterLink to="/Account/Login" class="m-2 mr-4">
                            <SecondaryButton class="m-2" href="/signin">Logi sisse</SecondaryButton>
                        </RouterLink>
                    </li>
                </template>
