        ...
        <fieldset>
          ...
          <div>
            ...
            <div class="mb-4">
              <TextInput
                id="sonad"
                v-model="request.sonad"
                placeholder="Laulu sõnade autor" />
            </div>
            <div class="mb-4">
              <TextInput
                id="viis"
                v-model="request.viis"
                placeholder="Laulu viisi autor" />
            </div>
            <div class="mb-4">
              <TagInput
                id="kogumik"
                v-model="request.kogumikud"
                placeholder="Kogumik"
                :allowableValues="kogumikud" />
            </div>
            <div class="mb-4">
              <SelectInput
                label="Helistik"
