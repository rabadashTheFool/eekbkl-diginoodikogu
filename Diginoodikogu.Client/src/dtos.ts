...
export class Variatsioon extends AuditBase
{
    ...
    public constructor(init?: Partial<Variatsioon>) { (Object as any).assign(this, init); }
}
...
export class Laul extends AuditBase
{
    ...
    public constructor(init?: Partial<Laul>) { (Object as any).assign(this, init); }
}
...
export class QueryLaulud extends QueryDb<Laul> implements IReturn<QueryResponse<Laul>>
{
    ...
    public createResponse() { return new QueryResponse<Laul>(); }
}
...
export class CreateLaul implements IReturn<IdResponse>, ICreateDb<Laul>
{
    ...
    public constructor(init?: Partial<CreateLaul>) { (Object as any).assign(this, init); }
    public getTypeName() { return 'CreateLaul'; }
...
export class UpdateLaul implements IReturn<IdResponse>, IPatchDb<Laul>
{
    ...
    public constructor(init?: Partial<UpdateLaul>) { (Object as any).assign(this, init); }
    public getTypeName() { return 'UpdateLaul'; }
...
// @ValidateRequest(Validator="HasRole(`Sisestaja`)")
export class CreateVariatsioon implements IReturn<IdResponse>, ICreateDb<Variatsioon>
{
    // @Required()
    public nimetus: string;
    // @Required()
    ...
    public constructor(init?: Partial<CreateVariatsioon>) { (Object as any).assign(this, init); }
    public getTypeName() { return 'CreateVariatsioon'; }
    public getMethod() { return 'POST'; }
    public createResponse() { return new IdResponse(); }
}
...
export class UpdateVariatsioon implements IReturn<IdResponse>, IPatchDb<Variatsioon>
{
    ...
    public constructor(init?: Partial<UpdateVariatsioon>) { (Object as any).assign(this, init); }
    public getTypeName() { return 'UpdateVariatsioon'; }
    public getMethod() { return 'PATCH'; }
    public createResponse() { return new IdResponse(); }
}
...
// @Route("/kogumik", "GET")
// @ValidateRequest(Validator="HasRole(`Kasutaja`)")
export class QueryKogumikud extends QueryDb<Kogumik> implements IReturn<QueryResponse<Kogumik>>
{
    public constructor(init?: Partial<QueryKogumikud>) { super(init); (Object as any).assign(this, init); }
    public getTypeName() { return 'QueryKogumikud'; }
    public getMethod() { return 'GET'; }
    public createResponse() { return new QueryResponse<Kogumik>(); }
}
...
export class CreateKogumik implements IReturn<IdResponse>, ICreateDb<Kogumik>
{
    ...
    public constructor(init?: Partial<CreateKogumik>) { (Object as any).assign(this, init); }
    public getTypeName() { return 'CreateKogumik'; }
    public getMethod() { return 'POST'; }
    public createResponse() { return new IdResponse(); }
}
