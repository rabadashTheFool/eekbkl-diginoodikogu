<template>
  <div class="mt-8 mx-auto max-w-lg">
    <div class="max-w-xl">
      <h1 class="mb-4 text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-50 sm:text-4xl">Logi sisse oma kasutajaga.</h1>
          ...
          <div>
            ...
            <div class="px-4 py-5 bg-white dark:bg-black space-y-6 sm:p-6">
              <div class="flex flex-col gap-y-4">
                <TextInput id="userName" label="E-mail" placeholder="E-mail" help="E-mail, millega kasutaja registreerisid" v-model="username"/>
                <TextInput id="password" label="Parool" placeholder="Parool" type="password" help="6 või rohkem tähemärki" v-model="password"/>
                <CheckboxInput id="rememberMe" label="Jäta mind meelde"/>
              </div>

              <div>
                <PrimaryButton id="login-submit" type="submit">Logi sisse</PrimaryButton>
              </div>

              <div class="mt-8 text-sm">
                <p class="mb-3">
                  <RouterLink class="font-semibold" to="/signup">Registreeri uus kasutaja</RouterLink>
                </p>
              </div>
