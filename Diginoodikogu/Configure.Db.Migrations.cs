...
using Diginoodikogu.Migrations;
using Diginoodikogu.ServiceModel;

[assembly: HostingStartup(typeof(Diginoodikogu.ConfigureDbMigrations))]
...
public class ConfigureDbMigrations : IHostingStartup
{
    public void Configure(IWebHostBuilder builder) => builder
        .ConfigureAppHost(appHost => {
            var migrator = new Migrator(appHost.Resolve<IDbConnectionFactory>(), typeof(Migration1001).Assembly);
    ...
    private async Task AddSeedUsers(IServiceProvider services)
    {
        ...
        string[] allRoles = [Roles.Admin, Roles.Sisestaja, Roles.Kasutaja];
        ...
        }, "p@55wOrd", [Roles.Kasutaja, Roles.Sisestaja]);
